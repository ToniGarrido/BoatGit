...
public class Empresa {
    ...
    private HashMap<Integer, Model> llistaVendes;
    private HashMap<Integer, Model> llistaVaixells;
    ...
    public ArrayList<Model> llistarMoDisponibles(Model model) {
        ...
        for (Model d : llistaModel){
            if(d.enVenta=EnumEstat.DISPONIBLE){
                llistaDisponible.add(d);
            }
        }
    ...
    public ArrayList<Model> llistarIntervalPreu(Double preuMinim, Double preuMaxim) {
        ...
        for(Model d : llistaModel){
            if(d.getPreu() > preuMinim && d.getPreu() < preuMaxim){
                modelsInterval.add(d);
            }
        }

...
public class TestLlistaVaixells {
    ...
    public void excepcioCaracters() throws LimitCaracterString, IdRepetit {
        Empresa empresaProva = new Empresa("EmpresaProva");
    ...
    public void excepcioIdRepetit() throws IdRepetit, LimitCaracterString {
        Empresa empresaProva = new Empresa("EmpresaProva");
    ...
    public void excepcioNoHiEsLlista() throws LimitCaracterString, NoHiEsLlista {
        Empresa empresaProva = new Empresa("EmpresaProva");
